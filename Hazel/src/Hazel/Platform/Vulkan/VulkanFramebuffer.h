...
namespace Hazel {
	...
	public:
		...
		virtual Ref<Image2D> GetImage(uint32_t attachmentIndex = 0) const override { ASSERT(attachmentIndex < m_AttachmentImages.size()); return m_AttachmentImages[attachmentIndex]; }
