...
namespace Hazel {
	...
	void VulkanTexture2D::Invalidate()
	{
		...
		samplerInfo.anisotropyEnable = VK_FALSE;  // TODO:���������ҪDevice��Features
	...
	void VulkanTexture2D::GenerateMips()
	{
		...
		Utils::InsertImageMemoryBarrier(blitCmd, info.Image,
			VK_ACCESS_TRANSFER_READ_BIT, VK_ACCESS_SHADER_READ_BIT,
			VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, image->GetDescriptorInfoVulkan().imageLayout, //TODO: ԭ��������û�а�Layout��Ϊԭʼimage��Layout
			VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
			subresourceRange);
	...
	void VulkanTextureCube::Invalidate()
	{
		...
		imageCreateInfo.arrayLayers = 6; // cubeMap������һ��ͼƬ���飬arrayLayers����ʾ6����
		imageCreateInfo.samples = VK_SAMPLE_COUNT_1_BIT;
		imageCreateInfo.tiling = VK_IMAGE_TILING_OPTIMAL; // VK_IMAGE_TILING_OPTIMAL �� Vulkan �Ƽ��Ĳ��֣�����������������ʺ� GPU ���ʵ��ڴ����з�ʽ��ͨ���������ţ��� CPU �޷�ֱ�ӷ��ʸò��ֵ�ͼ������
		...
		m_DescriptorImageInfo.imageLayout = VK_IMAGE_LAYOUT_GENERAL; // ͼƬ���ֶ���GENERAL
