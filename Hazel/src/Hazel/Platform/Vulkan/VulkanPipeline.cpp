		...
		RENDER_SUBMIT([instance]() mutable
			{
				...
				// ת��Ϊ Vulkan ԭ���� VkPushConstantRange �ṹ
				...
				for (uint32_t i = 0; i < pushConstantRanges.size(); i++) {
					...
					vulkanPushConstantRange.stageFlags = pushConstantRange.shaderStage;  // ���ý׶�
					vulkanPushConstantRange.offset = pushConstantRange.offset;            // ƫ����
					vulkanPushConstantRange.size = pushConstantRange.size;                // ��С
				}
				...
				rasterizationState.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;   // �����޳��Ķ���˳������ʱ��
